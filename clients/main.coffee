...
natives.declare("GetClientTime")
natives.declare("GetClientLatency")
natives.declare("GetClientAvgLatency")
natives.declare("GetClientAvgLoss")
natives.declare("GetClientAvgChoke")
natives.declare("GetClientAvgData")
natives.declare("GetClientAvgPackets")
